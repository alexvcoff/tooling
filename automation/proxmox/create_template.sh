...
function create_template() {
    ...
    #If the disk is already bigger than specified size, this will fail, and that is okay.
    qm disk resize $1 scsi0 $4
    #Make it a template
    qm template $1
...
export ssh_keyfile=/root/.ssh/sam_laptop.pub
...
create_template 900 "template-ubuntu-24-04" "ubuntu-24.04-server-cloudimg-amd64.img" "20G"
